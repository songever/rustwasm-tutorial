...
function js_add_and_print(a,b){ console.log("JS 计算结果:", a + b); Module._c_multiply_and_print(a, b); }
...
var asmLibraryArg = {
  ...
  "fd_write": _fd_write,
  "js_add_and_print": js_add_and_print,
...
/** @type {function(...*):?} */
var _c_multiply_and_print = Module["_c_multiply_and_print"] = createExportWrapper("c_multiply_and_print");
